...
const PAGE_META: Record<string, { title: string; sub: string }> = {
  ...
  '/admin/centro-costos/gastos-generales': { title: 'Centro de Costos', sub: 'Renta, sueldos, insumos y todo lo que no es carga ni envío' },
  '/admin/centro-costos/gastos-envios': { title: 'Centro de Costos', sub: 'Transporte, combustible y devoluciones de última milla' },
  '/admin/centro-costos/recepciones': { title: 'Centro de Costos', sub: 'Las libras que entran y lo que pagas por cada una' },
